...
![Notely Project preview image](https://github.com/elise-bigdevsoon/big-dev-soon-notely/blob/main/project-preview.png)
...
1. Head over to the [project page](https://app.bigdevsoon.me/projects/notely). Choose between Freerun or Speedrun mode, then click either the "Start Freerun" or "Start Speedrun" button.
...
2. **Project Page**: Loved the project? Share the [Notely](https://app.bigdevsoon.me/projects/notely) with your network. It’s a great way to challenge others and see what they can build.
